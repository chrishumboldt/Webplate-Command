   ...
   css: function (startMessage) {
      ...
      self.hasDirectory({
         ...
         self.hasDirectory({
            ...
            if (startMessage) { Rocket.log(colour.title('Building CSS...')) };
            // Run build
            cockpit.read(false, function (json) {
               // Catch
               if (!json || !Rocket.is.object(json)) {
                  return false;
               }
               // Continue
               if (Rocket.is.array(json.build)) {
   ...
   js: function (startMessage) {
      ...
      self.hasDirectory({
         ...
         self.hasDirectory({
            ...
            if (startMessage) { Rocket.log(colour.title('Building JS...')) };
            // Run build
            cockpit.read(false, function (json) {
               // Catch
               if (!json || !Rocket.is.object(json)) {
